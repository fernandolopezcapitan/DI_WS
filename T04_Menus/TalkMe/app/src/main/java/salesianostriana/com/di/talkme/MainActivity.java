...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Usuarios_item> usuarios;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usuarios.add(new Usuarios_item("Yoye"));
        usuarios.add(new Usuarios_item("Carlos"));
        usuarios.add(new Usuarios_item("Jesús"));
        usuarios.add(new Usuarios_item("Manuel"));
